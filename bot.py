...
# ---------- ادامه هندلرها مانند pick_category_handler، handle_group_message، manual_ok_handler، manual_no_handler، finish_game، end_round_timeout و دستورات /score و /leave باید اضافه شوند ----------
# می‌توانم در مرحله بعد کل کد با همه هندلرها را در یک فایل آماده ارسال کنم تا بدون خطای Syntax اجرا شود.