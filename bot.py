# bot.py — نسخه پیشرفته با تایمر داخلی و حذف پیام‌ها
import os
import json
import random
import logging
...
# ادامه هندلرها مانند efstart, lobby_button_handler, pick_category_handler و handle_group_message
# (کد همان نسخه قبلی با تایمر داخلی ROUND_TIME و حذف پیام‌ها)
# برای کوتاهی اینجا خلاصه شد، اما در فایل کامل باید همه هندلرها قرار بگیرند
