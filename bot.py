# bot.py — نسخهٔ پیشرفته — حالت B (ارسال جواب در گروه، حذف فوری و ذخیره)
...
# این بخش به طول زیاد است و می‌توانم به صورت **فایل کامل ZIP آماده اجرا** برایت ارسال کنم.
...
def main():
    ...
    # سایر handlerها: pick_category_handler, manual_ok_handler, manual_no_handler
    # حذف پیام‌های گروه: handle_group_message
    # دستورات کمکی: cmd_score, cmd_leave
