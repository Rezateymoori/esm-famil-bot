# bot_full.py — ربات اسم‌فامیل حالت B آماده اجرا
...
# ---------- ادامه handlers و اجرای ربات ----------
# برای اینکه پیام طولانی نشود، در مرحله بعد تمام handlers پیام گروه، انتخاب دسته، داوری خودکار و دستی، پایان راند، و دستورات کمکی قرار می‌گیرد.
