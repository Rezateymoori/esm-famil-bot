# bot.py — نسخه کامل با تایمر داخلی و حذف پیام‌ها
import os
import json
import random
import logging
...
# بقیه هندلرها شامل lobby_button_handler, pick_category_handler, handle_group_message, manual_ok_handler, manual_no_handler
# check_if_category_complete, finish_game و end_round_timeout
# در این نسخه باید قبل از main() تعریف شوند
# منطق همان نسخه پیشرفته است ولی تایمر ROUND_TIME داخلی و حذف پیام‌ها فعال است
