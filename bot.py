...
# ---------- ادامه handlerها و تابع‌های دیگر دقیقا مطابق نسخهٔ قبلی هستند ----------
...
def main():
    ...
    # سایر CallbackQueryHandler ها برای pick_category_handler، manual_ok_handler، manual_no_handler
    # MessageHandler برای handle_group_message
    # CommandHandler برای cmd_score و cmd_leave
